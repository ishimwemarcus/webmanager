...
export default function ShiftGateway() {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-navy-950/40 backdrop-blur-2xl p-4 overflow-hidden animate-fade-in">
      ...
      <div className="bg-white max-w-lg w-full relative z-[1001] rounded-2xl lg:rounded-3xl shadow-[0_32px_80px_rgba(0,0,0,0.2)] overflow-hidden border border-white/50 animate-scale-in max-h-[92dvh] overflow-y-auto">
        <div className="p-6 md:p-8 lg:p-10 text-center bg-gradient-to-b from-navy-50/50 to-transparent">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-navy-brand rounded-2xl mx-auto flex items-center justify-center mb-4 md:mb-6 shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500 border-4 border-white/20">
                <ShieldCheck className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </div>
            <h1 className="text-xl md:text-2xl lg:text-3xl font-black text-navy-950 uppercase tracking-tighter mb-2">MARC GATEWAY</h1>
        ...
        <form onSubmit={handleStartShift} className="p-6 md:p-8 lg:p-10 pt-2 space-y-5 md:space-y-6">
            <div className="space-y-4">
                ...
                <div className="relative group">
                    ...
                    <input 
                        ...
                        className="w-full bg-navy-50 border-2 border-transparent rounded-2xl pl-14 pr-4 py-4 md:py-5 text-navy-950 font-black focus:bg-white focus:border-navy-brand focus:ring-8 focus:ring-navy-brand/5 outline-none transition-all text-lg md:text-xl tracking-[0.2em] uppercase placeholder:text-navy-100 shadow-inner"
                        autoFocus
                    />
                </div>
            </div>
            ...
            <button type="submit" className="w-full py-4 md:py-5 rounded-2xl bg-navy-brand text-white text-sm font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 shadow-2xl hover:bg-navy-900 active:scale-95 transition-all group overflow-hidden relative">
