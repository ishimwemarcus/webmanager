...
export default function Sidebar({ className }) {
  ...
  return (
    <aside className={`w-72 glass-card border-r border-navy-100 flex flex-col flex-shrink-0 transition-all duration-300 no-print z-30 ${className}`}>
      <div className="p-8">
        <div
        ...
        >
          <div className="w-24 h-24 rounded-[2rem] bg-navy-50 p-4 shadow-2xl border border-navy-100 relative overflow-hidden group/logo-img flex items-center justify-center">
      ...
      <div className="px-4 py-1 flex-1 overflow-y-auto scrollbar-hide">
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-gray mb-6 ml-4 italic">Management Sectors</p>
            ...
            <NavLink
              ...
              className={({ isActive }) => `
                ...
                ${isActive 
                  ...
                  : 'hover:bg-navy-50 text-blue-gray hover:text-navy-950 hover:translate-x-1'}
                active:scale-95
              `}
            >
