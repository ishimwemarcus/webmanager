  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8 pb-20 animate-fade-in px-4 lg:px-0 relative">
      ...
      {store.syncStatus === 'error' && sales.length === 0 && (
        <div className="absolute inset-0 z-[100] bg-white/90 backdrop-blur-xl flex flex-col items-center justify-center text-center p-10 animate-fade-in" style={{ WebkitBackdropFilter: 'blur(24px)' }}>
           ...
           <h2 className="text-2xl md:text-3xl font-black text-navy-950 uppercase tracking-tighter mb-4">{L('Sync Connection Lost', 'Connexion Sync Perdue')}</h2>
           <p className="text-blue-gray font-bold uppercase tracking-widest text-xs md:text-sm mb-8 max-w-md leading-relaxed">
